...
const posicaoCorretoras_router_1 = __importDefault(require("./routers/posicaoCorretoras.router"));
const app = (0, express_1.default)();
const port = 3000;
app.use(express_1.default.json());
app.use(acoes_router_1.default, investimentos_router_1.default, clientes_router_1.default, corretoras_router_1.default, posicaoCorretoras_router_1.default);
app.get('/', (req, res) => {
