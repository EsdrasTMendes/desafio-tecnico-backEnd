...
describe('Testa se a função getAllStocks', () => {
    before(() => {
        ...
        sinon_1.default.stub(acoes_model_1.default, 'getAllStocks').resolves(ExpectReturn);
    });
    after(() => {
        acoes_model_1.default.getAllStocks.restore();
    });
    describe('retorne:', () => {
...
describe('Testa se a função getStockByCode', () => {
    before(() => {
        ...
        sinon_1.default.stub(acoes_model_1.default, 'getStockByCode').resolves(ExpectReturn);
    });
    after(() => {
...
describe('Testa se a função updateByCode', () => {
    before(() => {
        ...
        sinon_1.default.stub(acoes_model_1.default, 'updateByCode').resolves(ExpectReturn);
    });
    after(() => {
        acoes_model_1.default.updateByCode.restore();
    });
